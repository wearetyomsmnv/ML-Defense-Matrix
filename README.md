...
| **Мониторинг OSINT** | Отслеживание открытых источников на предмет упоминаний и угроз | AML.T0002 | Обнаружение |
| **Технологии Обмана** | Развертывание honeypot, пустых MlOps систем, и ложных целей для дезориентации атакующих | AML.T0000-T0002 | Превентивная |
